      ...
      <div className="App">
        ...
        <div className="social_icons_wrapper">
          ...
          <div className="social_icons">
            <svg id="github" className="social_icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 432 432" >
            ...
            <svg id="facebook" className="social_icon" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            viewBox="0 0 432 432" >
            ...
            <svg id="linkedin" className="social_icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              viewBox="0 0 432 432">
            ...
            <svg id="twitter" className="social_icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              viewBox="0 0 432 432">
            ...
            <svg id="instagram" className="social_icon" version="1.1" viewBox="0 0 512 512">
            ...
            <svg id="youtube" className="social_icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
              viewBox="0 0 432 432">
